...
fp = open("D:\\SteamLibrary\\steamapps\\common\\killer7\\Readonly\\subtitle\\st09J\\st09FontJ.sti", 'rb')
...
line1 = "最后的委托"
assert len(line1) == 5
strimage.header.chrNum = 5
strimage.str[0].strIndex[:5] = [0,1,2,3,4]
...
dest_sti   = r"D:/SteamLibrary/steamapps/common/killer7/Extracted/subtitle/st09J/st09FontJ.sti"
rsl_pack_exe = r"D:/SteamLibrary/steamapps/common/killer7/Tools/no_more_rsl/rslPack.exe"
target_dir = r"D:/SteamLibrary/steamapps/common/killer7/Extracted/subtitle/st09J"
shutil.copy2(source_sti, dest_sti)
subprocess.run([rsl_pack_exe, "--overwrite", target_dir], check=True)
modi_rsl = r"D:/SteamLibrary/steamapps/common/killer7/Extracted/subtitle/st09J.rsl"
targ_rsl = r"D:/SteamLibrary/steamapps/common/killer7/subtitle/st09J.rsl"
