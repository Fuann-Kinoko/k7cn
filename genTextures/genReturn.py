...
readonly_title  = "D:\\SteamLibrary\\steamapps\\common\\killer7\\ReadOnly\\return\\returnJ\\RETURNTITLEJ.BIN"
readonly_s01    = "D:\\SteamLibrary\\steamapps\\common\\killer7\\ReadOnly\\return\\returnJ\\Save_01.BIN"
readonly_s02    = "D:\\SteamLibrary\\steamapps\\common\\killer7\\ReadOnly\\return\\returnJ\\Save_02.BIN"

extracted_title  = "D:\\SteamLibrary\\steamapps\\common\\killer7\\Extracted\\return\\returnJ\\RETURNTITLEJ.BIN"
extracted_s01    = "D:\\SteamLibrary\\steamapps\\common\\killer7\\Extracted\\return\\returnJ\\Save_01.BIN"
extracted_s02    = "D:\\SteamLibrary\\steamapps\\common\\killer7\\Extracted\\return\\returnJ\\Save_02.BIN"
extracted_dir = "D:\\SteamLibrary\\steamapps\\common\\killer7\\Extracted\\return\\returnJ"
extracted_rsl = "D:\\SteamLibrary\\steamapps\\common\\killer7\\Extracted\\return\\returnJ.rsl"
dest_rsl = "D:\\SteamLibrary\\steamapps\\common\\killer7\\return\\returnJ.pak"

command = input("提取图片输入y;将修改后的图片封装回去输入n (y/n): ").lower().strip()
if command == "y":
    for r_tex in [readonly_title, readonly_s01, readonly_s02]:
        target_noext = os.path.join("genTextures", "return", os.path.basename(r_tex)[:-4])
    ...
    for e_tex in [extracted_title, extracted_s01, extracted_s02]:
        mod_img_png = os.path.join("genTextures", "return", os.path.basename(e_tex)[:-4] + "_mod.png")
