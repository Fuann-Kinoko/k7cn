...
if command == "y":
    for r_tex in [readonly_ru, readonly_ranai, readonly_t0, readonly_t1, readonly_t2, readonly_t3, readonly_t4, readonly_t5, readonly_t6, readonly_t7, readonly_t8, readonly_t9]:
    ...
    for e_tex in [extracted_ru, extracted_ranai, extracted_t0, extracted_t1, extracted_t2, extracted_t3, extracted_t4, extracted_t5, extracted_t6, extracted_t7, extracted_t8, extracted_t9]:
