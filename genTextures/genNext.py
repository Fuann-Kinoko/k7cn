...
readonly_hsmsg01    = "D:\\SteamLibrary\\steamapps\\common\\killer7\\ReadOnly\\scenario\\nextJ\\HS_msgJ.BIN"
readonly_hsmsg02    = "D:\\SteamLibrary\\steamapps\\common\\killer7\\ReadOnly\\scenario\\nextJ\\HS_msg2J.BIN"

extracted_hsmsg01   = "D:\\SteamLibrary\\steamapps\\common\\killer7\\Extracted\\scenario\\nextJ\\HS_msgJ.BIN"
extracted_hsmsg02   = "D:\\SteamLibrary\\steamapps\\common\\killer7\\Extracted\\scenario\\nextJ\\HS_msg2J.BIN"
extracted_dir = "D:\\SteamLibrary\\steamapps\\common\\killer7\\Extracted\\scenario\\nextJ"
extracted_rsl = "D:\\SteamLibrary\\steamapps\\common\\killer7\\Extracted\\scenario\\nextJ.rsl"
extracted_pak = "D:\\SteamLibrary\\steamapps\\common\\killer7\\Extracted\\scenario\\nextJ.pak"
dest_pak = "D:\\SteamLibrary\\steamapps\\common\\killer7\\scenario\\nextJ.pak"

command = input("提取图片输入y;将修改后的图片封装回去输入n (y/n): ").lower().strip()
if command == "y":
    for readonly_text in [readonly_hsmsg01, readonly_hsmsg02]:
        target_noext = os.path.join("genTextures", "next", os.path.basename(readonly_text)[:-4])
    ...
    for extracted_text in [extracted_hsmsg01, extracted_hsmsg02]:
        mod_img_png = os.path.join("genTextures", "next", os.path.basename(extracted_text)[:-4] + "_mod.png")
