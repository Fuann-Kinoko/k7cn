...
readonly_filename = "D:\\SteamLibrary\\steamapps\\common\\killer7\\ReadOnly\\logo\\logo\\selJap.bin"
extracted_filename = "D:\\SteamLibrary\\steamapps\\common\\killer7\\Extracted\\logo\\logo\\selJap.bin"
...
if command == "y":
    ...
    mod_img_png = os.path.join("genTextures", "logo", "selJap_mod.png")
    mod_img_dds = "selJap_mod.dds"
    command = [
        "texconv.exe",
